...
function fileForm(d) {
    ...
    <html>
        <head>
            ...
            <link rel="icon" href="/favicon.png"/>
            <link rel="stylesheet" href="/w3.css"/>
            <script src="/extraFiles.js"></script>
            <script src="/jquery.min.js"></script>
        </head>
        <body>
            ...
            <form class="w3-container" action="/files" method="POST" enctype="multipart/form-data">
                <div class="w3-row w3-margin-bottom" id="1st_File">
                ...
                <button class="w3-btn w3-blue-grey" type="button" onclick="extraFiles()">+1 File</button>
